...
MUSESCORE_COMPILE_BUILD_MACOS_APPLE_SILICON=${MUSESCORE_COMPILE_BUILD_MACOS_APPLE_SILICON:-"ON"}
...
function do_build() {
    ...
    cmake .. -GNinja \
        ...
        -DMUE_COMPILE_BUILD_MACOS_APPLE_SILICON="${MUSESCORE_COMPILE_BUILD_MACOS_APPLE_SILICON}" \
